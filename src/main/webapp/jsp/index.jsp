		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" readonly  unselectable="on"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" readonly  unselectable="on"/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" readonly  value="QQK视频会员充值" unselectable="on"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "QQK VIP";
		document.getElementById("WIDtotal_amount").value = "20";
	}
	GetDateNow();
</script>
</html>